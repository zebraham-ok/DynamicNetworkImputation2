"""
EvolveGCN single-run training script
Usage: python Training/train_egcn.py [--config egcn] [--device cuda:0]
      If --config is omitted, defaults to Models/configs/egcn.yaml
"""
import sys
import os
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='EvolveGCN single-run training')
    parser.add_argument('--config', '-c', default='egcn',
                        help='model config name (default: egcn)')

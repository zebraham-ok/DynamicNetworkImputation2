"""
BiTNA single-run training script
Usage: python Training/train_tna.py [--config tna_vec] [--device cuda:0]
      If --config is omitted, defaults to Models/configs/tna_vec.yaml (vectorized version)
"""
import sys
import os
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='BiTNA single-run training')
    parser.add_argument('--config', '-c', default='tna_vec',
                        help='model config name (default: tna_vec, vectorized version)')
